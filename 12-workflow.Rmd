...
However, this would not render in the output the content of `helpers.R` but only the content of the chunk. To succeed, you can use the `code` chunk option
...
You can learn more about chunk options in Section \@ref(knitr-options)
